...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img_A = self.transform(Image.open(os.path.join(self.pathA, img_nameA)).convert("RGB"))
        img_B = self.transform(Image.open(os.path.join(self.pathB, img_nameB)).convert("RGB"))
